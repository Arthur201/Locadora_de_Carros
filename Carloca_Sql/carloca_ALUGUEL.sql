...
CREATE TABLE `ALUGUEL` (
  ...
  CONSTRAINT `ID_ENDERECO_DEVOLUCAO` FOREIGN KEY (`ID_Endereco_devolucao`) REFERENCES `ENDERECO_UNIDADES` (`ID`),
  CONSTRAINT `ID_ENDERECO_RETIRADA` FOREIGN KEY (`ID_Endereco_retirada`) REFERENCES `ENDERECO_UNIDADES` (`ID`)
